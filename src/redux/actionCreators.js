...
export const postComment = (dishId, rating, author, comment) => (dispatch) => {
  ...
  return fetch(baseUrl + 'comments', {
    ...
    .then(response => {console.log('x:', response); return response;})
...
export const submitFeedback= (feedbackValues) => (dispatch) => {
  const newFeedback= {
  ...
  .then(response => response.json())
  .then(response => {dispatch(addFeedback(response));alert( "Thank you for your feedback! " + JSON.stringify( response ) )})
